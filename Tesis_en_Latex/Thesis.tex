...
% Márgenes (puede usarse left, right, bottom y top)
...
% Font Times (similar al Times New Roman), aplica para formulas tambien
\usepackage{mathptmx} 
\usepackage{amsmath,amsfonts,amssymb} 

% Manejo de headers y footers
\usepackage{fancyhdr}
...
% Para listas, establecer un margen
...
% Darle formato a los chapters, sections, subsections y subsubsections
\usepackage{titlesec}
...
\frontmatter % The \frontmatter command makes the pages numbered in lowercase roman (v, vii), NO ENUMERA LOS CHAPTERS, although each chapter’s title appears in the table of contents
...
\setlength{\parskip}{1em}   % Distanciamiento entre parrafos
\setlength{\parindent}{0cm} % Distancia de sangría al inicio -> 0
...
\input{Chapters/Chapter3}   % Revisión Literaria
\input{Chapters/Chapter4}   % Metodología
\input{Chapters/Chapter5}   % Resultados y Discusión
\input{Chapters/Chapter6}   % Conclusiones
\input{Chapters/Chapter7}   % Recomendaciones
\input{Chapters/Chapter8}   % Referencias Bibliográficas
\input{Chapters/Chapter9}   % Anexos
